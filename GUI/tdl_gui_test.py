...
# Global state
MAIN_ROOT = None
LANG = 'RU'            # Default language: 'RU' or 'EN'
MIN_PS_VERSION = 7     # Минимальная требуемая major-версия PowerShell

# Интернационализация меню
TEXTS = {
    'EN': {
        'menu': 'Menu:',
...
def login_telegram():
    ...
    run_powershell_script(exe, "login")
